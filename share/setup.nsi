...
!define COMPANY "Btn Core project"
...
VIAddVersionKey ProductName "Btn Core"
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\btn-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\Btn Core (testnet, -bit).lnk" "$INSTDIR\btn-qt" "-testnet" "$INSTDIR\btn-qt" 1
    ...
    WriteRegStr HKCR "btn" "URL Protocol" ""
    WriteRegStr HKCR "btn" "" "URL:Btn"
    WriteRegStr HKCR "btn\DefaultIcon" "" $INSTDIR\btn-qt
    WriteRegStr HKCR "btn\shell\open\command" "" '"$INSTDIR\btn-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\btn-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\Btn Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\Btn.lnk"
