...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Btn Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Btn Core"
...
#define PACKAGE_BUGREPORT "https://github.com/btnproject/btn/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Btn Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Btn Core 0.14.15"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "btn"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://btn.org/"
